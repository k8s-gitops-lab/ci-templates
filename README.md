...
include:
  - component: $CI_SERVER_FQDN/shared-ci/ci-templates/build-docker@v3.0.7
    inputs:
  ...
  - component: $CI_SERVER_FQDN/shared-ci/ci-templates/deploy-gitops@v3.0.7
    inputs:
      app_name: helloworld
  ...
  - component: $CI_SERVER_FQDN/shared-ci/ci-templates/promote@v3.0.7
    inputs:
      manifests_project_path: hello-groupe/helloworld-iac
